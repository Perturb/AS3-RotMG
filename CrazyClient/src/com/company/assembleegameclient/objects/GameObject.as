...
public class GameObject extends BasicObject
    {
        ...
        {
            return (!((this.condition_[1] & 0x010000) == 0));
        }
        ...
        override public function draw(_arg_1:Vector.<IGraphicsData>, _arg_2:Camera, _arg_3:int):void
        {
            ...
            if (_local_5)
            {
                _local_10 = uint(uint(((_local_4.getPixel32((_local_4.width / 4), (_local_4.height / 4)) | _local_4.getPixel32((_local_4.width / 2), (_local_4.height / 2))) | _local_4.getPixel32(((_local_4.width * 3) / 4), ((_local_4.height * 3) / 4)))));
            ...
            if ((((!(this.dead_)) && (Parameters.data_.showDamageOnEnemy)) && (!(Options.hidden))))
            {
                if (this.footer_)
                {
                    ...
                    {
                        _local_11 = uint(int(((_local_11 / this.maxHP_) * 100)));
