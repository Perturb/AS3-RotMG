...
public class UIGrid extends Sprite 
    {
        ...
        public function render():void
        {
            ...
            var _local_1:int = 1;
            var _local_5:int = int(int(Math.ceil((this.elements.length / this.numberOfColumns))));
            var _local_6:int = 1;
            for each (_local_8 in this.elements)
            {
                ...
                if (++_local_1 > this.numberOfColumns)
                {
                    ...
                    if (((_local_6 == _local_5) && (this._centerLastRow)))
                    {
                        ...
                        _local_2 = int(int(Math.round((((_local_9 * this.elementWidth) + ((_local_9 - 1) * this.gridMargin)) / 2))));
                    }
