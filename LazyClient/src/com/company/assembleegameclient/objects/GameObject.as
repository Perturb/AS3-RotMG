...
public class GameObject extends BasicObject
    {
        ...
        private var enemyIDShown:Boolean = false;
        ...
        private function enemyInfo(_arg_1:String):void
        {
        ...
        override public function update(_arg_1:int, _arg_2:int):Boolean
        {
            ...
            if (Parameters.data_.showEnemyID && this.props_.isEnemy_)
            {
                if (!this.enemyIDShown)
                {
                    if (this)
                    {
                        this.enemyInfo(((this.props_.id_ + "\n") + this.props_.type_));
                        this.enemyIDShown = true;
                    }
                }
            }
            else
            {
                this.enemyIDShown = false;
            }
